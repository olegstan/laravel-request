                ...
                try {
                    switch (xhr.status) {
                        ...
                        case 404:
                            ...
                            break;
                      case 422:
                          if(xhr?.responseJSON?.meta.message)
                            {
   ...
   */
    bind(obj, item, cb) {
        ...
        if (typeof item == 'object') {
            ...
            {
              self.responseBinding[self.responseBinding.length] = new Binding(obj, data[0], data[1], cb);

              return;
            })
        } else {
            this.responseBinding = new Binding(obj, item, key, cb);
        }
    }
